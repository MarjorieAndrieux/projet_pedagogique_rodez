...
<body>
    <div class="container-fluid">
        <nav class="navbar navbar-expand-lg " id="nav_bar">
            ...
            <a class="navbar-brand" href="#" id="logo"><img src="images/logo.jpg" width="70" height="70"></a>
            <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
                ...
                <form class="form-inline my-2 my-lg-0" id="recherche">
                    ...
                    <button class="btn btn-outline-success my-2 my-sm-0" type="submit" id="btn_recherche"><img src="images/loupe.png" id="img_btn_recherche"></button>
                </form>
            </div>
        </nav>
    </div>
